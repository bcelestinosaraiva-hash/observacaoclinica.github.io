// push-notify.js — envia notificações push para novos artigos
// Uso: import { notifyNewArticles } from "./push-notify.js";
//      await notifyNewArticles([{ title: "Nome do Artigo", url: "https://observacaoclinica.com/saude-az/..." }]);
...
/**
 * @param {Array<{title: string, url: string}>} articles — apenas artigos NOVOS (não edições)
 */
